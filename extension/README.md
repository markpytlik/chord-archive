# Chordpad — Browser Extension

One-click chord-chart capture for [Chordpad](https://chordpad.app/).
...
4. Chordpad opens in a new tab — paste into the lyrics field, click **Parse pasted sheet**.
...
[`chordpad-1.5.2.xpi`](https://chordpad.app/chordpad-1.5.2.xpi)
...
- `icon.svg` — extension icon (a music note in the Chordpad accent color).
